...
const ProductDetails = () => {
  ...
  const relatedProducts = products.filter(item => item.category);
  ...
  const submitHandler = (e)=> {
    ...
    toast.success('Your review is appreciated.')
        ...
        <Container>
          <Row>
            <Col lg='6'>
              ...
              <img src={imgUrl} alt='' className='mt-5'/>
              </div>
...
{/* ==================== Review form */}
                        <div className="review__form">
                          ...
                          <form action='' onSubmit={submitHandler}>
                            ...
                            <div className="form__group d-flex align-items-center gap-5 my-3 rating__group">
                              <span whileTap={{scale:1.2}} onClick={() => setRating(1)}
