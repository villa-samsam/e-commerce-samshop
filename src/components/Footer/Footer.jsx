        ...
        <Row>
          ...
          <div className="logo">
            ...
            <p className="footer__text mt-4">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Mollitia aspernatur vitae quisquam iusto optio, porro cupiditate quidem aliquam impedit.
              </p>
          </Col>
{/* ===========Top Categories ============== */}
     ...
     {/* ======== Footer Contact ================*/}
          ...
          <Col lg='12'>
            <p className="footer__copyright text-center">Copyright {year} developed by Christine Mae Villamero. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
